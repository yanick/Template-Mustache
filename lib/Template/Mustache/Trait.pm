...
$Template::Mustache::Trait::VERSION = '1.0.0_0'; # TRIAL

$Template::Mustache::Trait::VERSION = '1.0.00';
use Moose::Role;
...
our $AUTHORITY = 'cpan:YANICK';
$Moose::Meta::Attribute::Custom::Trait::Mustache::VERSION = '1.0.0_0'; # TRIAL

$Moose::Meta::Attribute::Custom::Trait::Mustache::VERSION = '1.0.00';sub register_implementation { 'Template::Mustache::Trait' }
