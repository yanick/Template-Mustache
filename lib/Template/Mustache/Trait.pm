...
$Template::Mustache::Trait::VERSION = '1.0.1_0'; # TRIAL

$Template::Mustache::Trait::VERSION = '1.0.10';
use Moose::Role;
...
our $AUTHORITY = 'cpan:YANICK';
$Moose::Meta::Attribute::Custom::Trait::Mustache::VERSION = '1.0.1_0'; # TRIAL

$Moose::Meta::Attribute::Custom::Trait::Mustache::VERSION = '1.0.10';sub register_implementation { 'Template::Mustache::Trait' }
